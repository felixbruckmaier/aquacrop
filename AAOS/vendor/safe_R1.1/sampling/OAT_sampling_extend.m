function [Xext, Xnew, r_ext] = OAT_sampling_extend(X,r_ext,distr_fun,distr_par,des_type,extrainput,varargin)
%
...
[ABext, r_ext]=AAT_sampling_extend(AB_old,distr_fun,distr_par,2*r_ext,extrainput,nrep);
