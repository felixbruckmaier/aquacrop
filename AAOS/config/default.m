...
Config.RUN_type = "CAL";
% Define number of elementary effects for Morris Method:
Config.ElementaryEffects = 1000;
...
%% Format of input parameters in date format = PlantingDate, HarvestDate
%Config.DateFormat = 'ddmmyyyy'; % must match with format in AAOS input files